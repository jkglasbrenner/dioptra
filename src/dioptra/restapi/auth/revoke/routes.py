...
"""Methods for registering the auth/revoke endpoint routes with the main application.
...
BASE_ROUTE: str = "auth/revoke"


def register_routes(api: Api, app: Flask, root: str = "api") -> None:
    """Registers the auth/revoke endpoint routes with the main application.
