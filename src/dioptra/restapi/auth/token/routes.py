...
"""Methods for registering the auth/token endpoint routes with the main application.
...
BASE_ROUTE: str = "auth/token"


def register_routes(api: Api, app: Flask, root: str = "api") -> None:
    """Registers the auth/token endpoint routes with the main application.
