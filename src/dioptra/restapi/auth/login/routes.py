...
"""Methods for registering the auth/login endpoint routes with the main application.
...
BASE_ROUTE: str = "auth/login"


def register_routes(api: Api, app: Flask, root: str = "api") -> None:
    """Registers the auth/login endpoint routes with the main application.
